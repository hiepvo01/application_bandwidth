...
# CSV file name
CSV_FILE = "network_usage_log.csv"
...
def write_to_csv(df):
    """Write the current network usage data to a CSV file"""
...
if __name__ == "__main__":
    ...
    if not os.path.exists(CSV_FILE):
        with open(CSV_FILE, 'w', newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Timestamp', 'PID', 'Process Name', 'Upload', 'Download', 'Upload Speed', 'Download Speed'])
